                    ...
                    if (selection.width == 0.0 || selection.height == 0.0) {
                        for (index in shpList.indices) {
                            ...
                            if (selectedFeatureParams.featureList[index].isNotEmpty()) {
                                print("The ${shpList[index].shpHeader.shapeType} number is ")
                                for (shpRecord in selectedFeatureParams.featureList[index]) {
                                     print("${shpRecord.recordHeader.recordNumber} ")
                                }
                                println("")
                            }
                        }
